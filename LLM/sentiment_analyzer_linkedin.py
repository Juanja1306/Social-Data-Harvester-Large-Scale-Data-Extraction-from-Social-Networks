...
def generar_reporte(resultados: List[Dict]) -> str:
    ...
    reporte = f"""
        ...
        • Reducción de tiempo estimada vs secuencial: ~{round((1 - (tiempo_promedio * total_publicaciones) / sum(tiempos_procesamiento)) * 100, 1) if tiempos_procesamiento and total_publicaciones > 0 else 0}%
